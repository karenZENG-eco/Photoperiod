...
#extra code to add simple photoperiod section for analyses
```{r}
pp <- read.csv("./data/appendix1.csv")
pp$simple_photoperiodism <- "other" #new column simplifying photoperiodism
...
write.csv(pp,"./data/appendix1.csv", row.names = F)
rm(pp)
```
