...
fig_ppyear
 ...
 ggexport(fig_ppyear, filename = "./figures/appendix_fig_2.tiff", width = 2040, height = 1020, res = 300)
```
...
```{r}
fig_3maps <- annotate_figure(
  ggarrange(ncol = 3,
            fig_namap+ rremove("ylab"),
            fig_sdmap+ rremove("ylab"), 
            fig_ldmap+ rremove("ylab"),
            labels = c("a)", "b)", "c)")),
  left = text_grob("Latitude", rot = 90, 
                   face = "bold", 
                   size = 12)) 
ggexport(fig_3maps, filename = "./figures/fig_3maps.tiff", width = 2040, height = 1020, res = 300)
```
...
fig_1 <- 
  ...
  geom_segment(aes(x = 1950, y = 135.3, xend = 2017, yend = 129.0), colour = mypalette[3], size = 1)+ #na
    geom_segment(aes(x = 1950, y = 146.9, xend = 2017, yend = 148.1), colour = mypalette[2], size = 1)+ #ld
    geom_segment(aes(x = 1950, y = 172.1, xend = 2017, yend = 162.5), colour = mypalette[1], size = 1)+ #sd 
  xlab("Year")+
  ylim(-1, 366)+
  xlim(1949, 2017)+
...
ggexport(fig_1, filename = "./figures/fig_1.tiff", width = 2040, height = 1530, res = 300)
```
